    ...
    <section>
        <nav class="mango_mid navbar navbar-expand-lg navbar-light ">
            <div class="mr-auto col-sm-3 col-lg-2 col-xs-12">
                <img src='logo.png' width="150px" height="55px" alt="Responsive image" class="d-inline-block align-left">
            </div>
    ...
    <section id="breadcrumb">
        <div class="container col-lg-12 mt-3">
            <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="index.html"></a>Dashboard</a></li>
                    <li class="breadcrumb-item active">Estimations</a></li>
